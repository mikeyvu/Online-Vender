    ...
    <main class="main">
        <div class="order-summary-container">
            ...
            <div class="action-buttons">
                <a href="<%=request.getContextPath()%>/client/shopping-cart/shopping_cart.jsp" class="btn-back">
                    <i class="bi bi-arrow-left"></i> Back to Cart
                </a>
                <a href="<%=request.getContextPath()%>/client/payment/payment.jsp" class="btn-payment" id="proceed-payment-btn">
